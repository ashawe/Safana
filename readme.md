...
### Get DEMO APK [HERE](https://github.com/ashawe/Safana/releases/tag/v1.0) use SUP001 AND EMP1523 as login ids for supervisor and employee respectively. Passwords are same as login id 
### User Manual
#### Employee/Worker
<table>
  <tr>
